        ...
        foreach ($attributes as $key => $mixed) {
            ...
            if (!is_array($mixed)) {
                ...
                if (in_array(trim($mixed, '\'"'), $this->option_flags)) {
                	...
                	// FIXME : verify this doesn't break anything else [marius.orcsik@avangate.com]
                	/**
                	 * I replaced the error trigger with adding the $mixed variable to the parameters using a numeric index 
                     * // too many shorthands
