	...
	<div class="prod_details" style="; overflow:visible;">
		<div class="prod_description">
			<div style="float:left; width:520px">
				<a href="product-details.php?id=<?php echo $prod->ProductId?>"><img src="<?php echo !is_null($prod->ProductImage) ? $prod->ProductImage : '/htdocs/images/defaultprod.png';?>" style="width:80px; float:left" /></a>
				<h4><a href="product-details.php?id=<?php echo$prod->ProductId?>"><?php echo $prod->ProductName ?></a> <?php if ($prod->ProductVersion) {?><span>(v <?php echo $prod->ProductVersion; ?>)</span><?php }?></h4>
			...
			<form action="/cart.php?action=add" method="post" class="frm">
